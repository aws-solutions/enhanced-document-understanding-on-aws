...
operations_dictionary = {
    operation_types.COPY_TEMPLATE: copy_email_templates.execute,
    operation_types.COPY_SAMPLE_DOCUMENTS: copy_sample_documents.execute,
    ...
    operation_types.COPY_WORKFLOW_CONFIG: copy_workflow_config_to_ddb.execute,
