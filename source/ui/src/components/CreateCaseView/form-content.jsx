...
function BaseFormContent({ content, onCancelClick, errorText = null, onCreateClick, currentStatus }) {
    let statusLabel = '';
...
export function FormContent({ handleButtonClick, caseNameError, currentStatus }) {
    ...
    return (
        <BaseFormContent
            ...
            onCreateClick={() => handleButtonClick(caseName)}
